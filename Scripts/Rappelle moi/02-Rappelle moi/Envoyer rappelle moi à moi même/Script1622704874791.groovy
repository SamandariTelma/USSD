...
String monMsisdn=CustomKeywords.'ussd.Util.to034'(GlobalVariable.msisdn1Initiateur)
'En tant que client TELMA, je vais dans mon USSD en composant le short code *130*2*1#'

CustomKeywords.'ussd.Send.code'(GlobalVariable.shortCode+'*1#', GlobalVariable.msisdn1Initiateur)
