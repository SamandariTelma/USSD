...
String actualMenu=CustomKeywords.'ussd.Send.code'(GlobalVariable.shortCode+'*5#', GlobalVariable.msisdnInitiateur)
...
'Je rentre à nouveau dans le menu Demander SOS crédit a telma en saisissant 2'
actualMenu=CustomKeywords.'ussd.Send.response'('2')
