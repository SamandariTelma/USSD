...
String actualMenu=CustomKeywords.'ussd.Send.code'(GlobalVariable.shortCoddeDirect+'*0325785400*1000#', numeroInitiateur)
...
actualMenu=CustomKeywords.'ussd.Send.code'(GlobalVariable.shortCoddeDirect+'*261346848017*1000#', numeroInitiateur)
...
actualMenu=CustomKeywords.'ussd.Send.code'(GlobalVariable.shortCoddeDirect+'*12345*1000#', numeroInitiateur)
