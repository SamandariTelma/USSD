...
'Je saisi 3 (YELOW FACEBOBAKA)'
String actualMenu = CustomKeywords.'ussd.Send.response'('3')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA, YELOW FACEBOBAKA, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra YELOW FACEBOBAKA, tsindrio ny 1')
