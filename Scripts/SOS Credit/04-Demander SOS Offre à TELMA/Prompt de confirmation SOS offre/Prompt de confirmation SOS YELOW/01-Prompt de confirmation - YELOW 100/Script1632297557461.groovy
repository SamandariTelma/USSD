...
'Je saisi 1 (YELOW 100)'
String actualMenu = CustomKeywords.'ussd.Send.response'('1')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA, YELOW100, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra YELOW100, tsindrio ny 1')
