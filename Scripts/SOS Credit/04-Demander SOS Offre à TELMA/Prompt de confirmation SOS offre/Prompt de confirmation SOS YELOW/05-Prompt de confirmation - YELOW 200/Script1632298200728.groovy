...
'Je saisi 5 (YELOW 200)'
String actualMenu = CustomKeywords.'ussd.Send.response'('5')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA, YELOW 200, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra YELOW 200, tsindrio ny 1')
