...
'Je saisi 6 (YELOW 200)'
String actualMenu = CustomKeywords.'ussd.Send.response'('6')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA, YELOW FACEBOOBAKA \\+, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra YELOW FACEBOOBAKA \\+, tsindrio ny 1')
