...
'Je saisi 1 (NET ONE WEEK 250 Mo)'
String actualMenu = CustomKeywords.'ussd.Send.response'('2')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA, ONE WEEK 250 Mo, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra ONE WEEK 250 Mo, tsindrio ny 1')
