...
'Je saisi 3 (NET ONE WEEK 1,5 Go)'
String actualMenu = CustomKeywords.'ussd.Send.response'('3')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA, ONE WEEK 1,5 Go, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra ONE WEEK 1,5 Go, tsindrio ny 1')
