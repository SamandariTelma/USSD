...
'Je saisi 3 (NET 9 MOIS)'
String actualMenu = CustomKeywords.'ussd.Send.response'('3')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'(actualMenu, 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra NET 9 MOIS, tsindrio ny 1')
