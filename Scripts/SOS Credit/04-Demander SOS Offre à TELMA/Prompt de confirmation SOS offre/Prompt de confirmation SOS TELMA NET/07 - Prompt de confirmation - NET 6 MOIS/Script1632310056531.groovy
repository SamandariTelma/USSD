...
'Je saisi 2 (NET 6 MOIS)'
String actualMenu = CustomKeywords.'ussd.Send.response'('2')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'(actualMenu, 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra NET 6 MOIS, tsindrio ny 1')
