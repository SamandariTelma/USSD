...
'Je saisis 1 pour (NET JOURNALIER)'
CustomKeywords.'ussd.Send.response'('1')

'Je saisi 2 (YE\'LOW ONE)'
String actualMenu = CustomKeywords.'ussd.Send.response'('2')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA,de l\'offre YE\'LOW ONE, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra YE\'LOW ONE, tsindrio ny 1')
