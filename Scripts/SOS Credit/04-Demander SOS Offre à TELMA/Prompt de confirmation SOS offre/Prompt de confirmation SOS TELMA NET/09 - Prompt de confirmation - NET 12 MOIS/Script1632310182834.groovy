...
'Je saisis 3 pour (NET MENSUALITE EN AVANCE)'
CustomKeywords.'ussd.Send.response'('3')

'Je saisi 4 (NET 12 MOIS)'
String actualMenu = CustomKeywords.'ussd.Send.response'('4')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'(actualMenu, 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra NET 12 MOIS, tsindrio ny 1')
