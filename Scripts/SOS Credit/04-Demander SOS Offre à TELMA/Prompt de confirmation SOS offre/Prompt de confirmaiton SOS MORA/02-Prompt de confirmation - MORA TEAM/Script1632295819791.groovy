...
'Je saisi 2 (MORA TEAM)'
String actualMenu = CustomKeywords.'ussd.Send.response'('2')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA, MORA TEAM, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra MORA TEAM, tsindrio ny 1')
