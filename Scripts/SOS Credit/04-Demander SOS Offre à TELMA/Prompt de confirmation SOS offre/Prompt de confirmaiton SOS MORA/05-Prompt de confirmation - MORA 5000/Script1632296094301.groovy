...
'Je saisi 5 (MORA+ 5000)'
String actualMenu = CustomKeywords.'ussd.Send.response'('5')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA, MORA\\+ 5000, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra MORA\\+ 5000, tsindrio ny 1')
