...
'Je saisi 4 (MORA+ 2000)'
String actualMenu = CustomKeywords.'ussd.Send.response'('4')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA, MORA\\+ 2000, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra MORA\\+ 2000, tsindrio ny 1')
