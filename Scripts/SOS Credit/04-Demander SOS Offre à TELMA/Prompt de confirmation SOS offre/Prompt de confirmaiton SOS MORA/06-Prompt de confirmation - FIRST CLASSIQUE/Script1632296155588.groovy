...
'Je saisi 6 (FIRST CLASSIQUE)'
String actualMenu = CustomKeywords.'ussd.Send.response'('6')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA, FIRST CLASSIQUE, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra FIRST CLASSIQUE, tsindrio ny 1')
