...
'Je saisi 1 (MORA NIGHT)'
String actualMenu = CustomKeywords.'ussd.Send.response'('1')

'Je vérifie la conformité du prompt'
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer votre demande de SOS a TELMA, MORA NIGHT, Taper 1', 'Raha hanamarina ny fangatahana SOS @ TELMA, ny tolotra MORA NIGHT, tsindrio ny 1')
