...
menu=CustomKeywords.'ussd.Expected.menu'('Pour confirmer la reception d un code OTP pour l installation de l application Telma&moi, entrer votre code secret MVola:')
