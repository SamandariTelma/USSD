...
WebUI.callTestCase(findTestCase('Configurer mon mobile/Desactiver INTERNET/Désactiver INTERNET'), [('numeroInitiateur') : numeroInitiateur], 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('Configurer mon mobile/Desactiver INTERNET/RéActiver internet désactivé'), [('numeroInitiateur') : numeroInitiateur], 
    FailureHandling.CONTINUE_ON_FAILURE)
