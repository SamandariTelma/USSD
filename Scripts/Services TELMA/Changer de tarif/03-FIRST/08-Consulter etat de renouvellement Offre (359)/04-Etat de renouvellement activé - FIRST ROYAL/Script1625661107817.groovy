...
'Je saisis le rang du menu FIRST ROYAL et valide'
...
String menu=CustomKeywords.'ussd.Expected.menu'('1 Votre offre FIRST ROYAL sera automatiquement renouvelee le '+dateExpiration+' a minuit\\. Pour desactiver le renouvellement tapez 1',
	'1 Ny tolotra FIRST ROYAL dia hohavaozina ny '+dateExpiration+' @ misasak\'alina\\. Raha hanafoana io fanavaozana io, tsindrio 1')
