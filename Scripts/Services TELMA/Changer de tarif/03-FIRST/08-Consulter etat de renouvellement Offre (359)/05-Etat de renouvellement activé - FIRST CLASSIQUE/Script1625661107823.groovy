...
'Je saisis le rang du menu FIRST CLASSIQUE et valide'
...
String menu=CustomKeywords.'ussd.Expected.menu'('1 Votre offre FIRST CLASSIQUE sera automatiquement renouvelee le '+dateExpiration+' a minuit\\. Pour desactiver le renouvellement tapez 1',
	'1 Ny tolotra FIRST CLASSIQUE dia hohavaozina ny '+dateExpiration+' @ misasak\'alina\\. Raha hanafoana io fanavaozana io, tsindrio 1')
