...
String menu=CustomKeywords.'ussd.Expected.menu'('Vous avez desactive avec succes le renouvellement automatique de l offre FIRST ROYAL\\. Pour le reactiver, tapez #359\\*95\\*1#')
