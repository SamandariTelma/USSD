...
'Je saisis 1(NET 3 MOIS)'
String actualMenu=CustomKeywords.'ussd.Send.response'('1')

'Je vérifie la conformité du message'
String menu=CustomKeywords.'ussd.Expected.menu'('Votre NET 3 MOIS est activee\\. Vous avez 250 Mo/mois pendant 3 mois\\. Bonus restant #359#\\. Achetez via MVola et gagnez un bonus Kadoa de 20%\\. \\(#111\\*1#\\)',
	'Tafiditra ny tolotra NET 3 MOIS\\.Manana 250Mo isam bolana ianao mandritry ny 3 volana\\. Bonus #359#\\.Vidio @Mvola ny tolotra ary mahazoa bonus KADOA 20%\\. \\(#111\\*1#\\)')
