...
String menu=CustomKeywords.'ussd.Expected.menu'('Vous avez desactive avec succes le renouvellement automatique de l offre NET 6 MOIS\\. Pour le reactiver, tapez #359\\*82\\*1#')
