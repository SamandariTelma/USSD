...
'Après achat Offre TELMA NET ONE NIGHT avec succès , je consulte mon solde en saisissant #359#'
...
String rangMenu=CustomKeywords.'ussd.Util.rechercheMenu'('NET ONE NIGHT', actualMenu)

'Je saisis le rang du menu NET ONE NIGHT et valide'
actualMenu=CustomKeywords.'ussd.Send.response'(rangMenu)

'Vérifier la conformité du message'
String menu=CustomKeywords.'ussd.Expected.menu'('NET ONE NIGHT\n1 Info conso\n00 Page precedente',
	'NET ONE NIGHT\n1 Info conso\n00 Pejy aloha')
