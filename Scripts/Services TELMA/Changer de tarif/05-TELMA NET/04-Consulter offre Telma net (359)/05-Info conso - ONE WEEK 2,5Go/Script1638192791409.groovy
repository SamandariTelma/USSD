...
'Après achat Offre TELMA NET ONE WEEK 2,5Go avec succès , je consulte mon solde en saisissant #359#'
...
String rangMenu=CustomKeywords.'ussd.Util.rechercheMenu'('NET ONE WEEK 2,5Go', actualMenu)

'Je saisis le rang du menu NET ONE WEEK 2,5Go et valide'
actualMenu=CustomKeywords.'ussd.Send.response'(rangMenu)

'Vérifier la conformité du message'
String menu=CustomKeywords.'ussd.Expected.menu'('NET ONE WEEK 2,5Go\n1 Info conso\n00 Page precedente',
	'NET ONE WEEK 2,5Go\n1 Info conso\n00 Pejy aloha')
