...
String rangMenu=CustomKeywords.'ussd.Util.rechercheMenu'('NET ONE MONTH 1,5Go', actualMenu)

'Je saisis le rang du menu NET ONE MONTH 1,5Go et valide'
actualMenu=CustomKeywords.'ussd.Send.response'(rangMenu)

'Vérifier la conformité du message'
String menu=CustomKeywords.'ussd.Expected.menu'('NET ONE MONTH 1\\,5Go\n1 Info conso\n00 Page precedente',
	'NET ONE MONTH 1\\,5Go\n1 Info conso\n00 Pejy aloha')
