...
'Vérifier la conformité du message'
menu=CustomKeywords.'ussd.Expected.menu'('NET ONE MONTH 2,5 Go, il vous reste 3072\\.0 Mo utilisable a toute heure jusqu au '+dateExpiration+' inclus\\.',
	'NET ONE MONTH 2,5 Go, 3072\\.0  Mo sisa ny bonus-nao azo ampiasaina @ ora rehetra hatramin ny '+dateExpiration+'\\.')
