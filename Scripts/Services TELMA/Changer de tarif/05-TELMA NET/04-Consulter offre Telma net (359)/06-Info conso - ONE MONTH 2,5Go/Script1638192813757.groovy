...
String rangMenu=CustomKeywords.'ussd.Util.rechercheMenu'('NET ONE MONTH 2,5Go', actualMenu)

'Je saisis le rang du menu NET ONE MONTH 2,5Go et valide'
actualMenu=CustomKeywords.'ussd.Send.response'(rangMenu)

'Vérifier la conformité du message'
String menu=CustomKeywords.'ussd.Expected.menu'('NET ONE MONTH 2\\,5Go\n1 Info conso\n00 Page precedente',
	'NET ONE MONTH 2\\,5Go\n1 Info conso\n00 Pejy aloha')
...
'Vérifier la conformité du message'
menu=CustomKeywords.'ussd.Expected.menu'('NET ONE MONTH 2,5 Go, il vous reste 2560\\.0 Mo utilisable a toute heure jusqu au '+dateExpiration+' inclus\\.',
	'NET ONE MONTH 2,5 Go, 2560\\.0  Mo sisa ny bonus-nao azo ampiasaina @ ora rehetra hatramin ny '+dateExpiration+'\\.')
