...
'Après achat Offre TELMA NET ONE MONTH 12Go avec succès , je consulte mon solde en saisissant #359#'
...
String rangMenu=CustomKeywords.'ussd.Util.rechercheMenu'('NET ONE MONTH 12Go', actualMenu)

'Je saisis le rang du menu NET ONE MONTH 12Go et valide'
actualMenu=CustomKeywords.'ussd.Send.response'(rangMenu)

'Vérifier la conformité du message'
String menu=CustomKeywords.'ussd.Expected.menu'('NET ONE MONTH 12Go\n1 Info conso\n00 Page precedente',
	'NET ONE MONTH 12Go\n1 Info conso\n00 Pejy aloha')
...
'Vérifier la conformité du message'
menu=CustomKeywords.'ussd.Expected.menu'('NET ONE MONTH 12 Go, il vous reste 12288\\.0 Mo utilisable a toute heure jusqu au '+dateExpiration+' inclus\\.',
