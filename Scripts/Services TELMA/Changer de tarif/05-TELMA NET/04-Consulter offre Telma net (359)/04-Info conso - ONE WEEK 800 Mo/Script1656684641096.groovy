...
'Après achat Offre TELMA NET ONE WEEK 800 Mo avec succès , je consulte mon solde en saisissant #359#'
...
String rangMenu=CustomKeywords.'ussd.Util.rechercheMenu'('NET ONE WEEK 800Mo', actualMenu)

'Je saisis le rang du menu NET ONE WEEK 800 Mo et valide'
actualMenu=CustomKeywords.'ussd.Send.response'(rangMenu)

'Vérifier la conformité du message'
String menu=CustomKeywords.'ussd.Expected.menu'('NET ONE WEEK 800Mo\n1 Info conso\n00 Page precedente',
	'NET ONE WEEK 800Mo\n1 Info conso\n00 Pejy aloha')
...
'Vérifier la conformité du message'
menu=CustomKeywords.'ussd.Expected.menu'('NET ONE WEEK 800 Mo, il vous reste 800\\.0 Mo utilisable a toute heure jusqu au '+dateExpiration+' inclus\\.',
