...
'Après achat Offre TELMA NET ONE MONTH 30Go avec succès , je consulte mon solde en saisissant #359#'
...
String rangMenu=CustomKeywords.'ussd.Util.rechercheMenu'('NET ONE MONTH 30Go', actualMenu)

'Je saisis le rang du menu NET ONE MONTH 30Go et valide'
