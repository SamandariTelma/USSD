...
'Vérifier la conformité du message'
menu=CustomKeywords.'ussd.Expected.menu'('NET 3 MOIS, vous beneficiez de 250 Mo par mois pendant 3 mois, il vous reste 250\\.0 Mo utilisable jusqu au '+dateExpiration+' inclus\\.',
	'NET 3 MOIS mahazo 250 Mo isambolana ianao mandritra ny 3 volana\\. 250\\.0 Mo sisa ny bonus-nao azo ampiasaina hatramin ny '+dateExpiration+'\\.')
