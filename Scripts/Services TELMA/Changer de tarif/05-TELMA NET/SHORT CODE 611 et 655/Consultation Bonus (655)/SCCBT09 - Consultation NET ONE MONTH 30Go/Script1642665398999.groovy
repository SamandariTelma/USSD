...
'En tant que GP, je consulte mon offre NET ON MONTH 30Go :  *655*17#'
String actualMenu=CustomKeywords.'ussd.Send.code'(GlobalVariable.shortCodeDirect+'*17#', numeroInitiateur)
