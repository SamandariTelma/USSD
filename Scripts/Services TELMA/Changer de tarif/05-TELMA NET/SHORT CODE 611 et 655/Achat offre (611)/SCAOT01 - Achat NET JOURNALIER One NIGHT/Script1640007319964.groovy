...
'En tant que GP, j\'effectue mon offre NET One NIGHT :  *611*61#'
String actualMenu=CustomKeywords.'ussd.Send.code'(GlobalVariable.shortCoddeDirectAchat+'*61#', numeroInitiateur)
