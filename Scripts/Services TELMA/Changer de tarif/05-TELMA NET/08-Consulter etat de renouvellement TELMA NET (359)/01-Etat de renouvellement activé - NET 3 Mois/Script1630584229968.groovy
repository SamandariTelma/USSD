...
'Après achat Offre NET 3 MOIS avec succès , je consulte mon solde en saisissant #359#'
...
String menu=CustomKeywords.'ussd.Expected.menu'('1 Votre offre NET 3 MOIS sera automatiquement renouvelee le '+dateExpiration+' a minuit\\. Pour desactiver le renouvellement tapez 1',
	'1 Ny tolotra NET 3 MOIS dia hohavaozina ny '+dateExpiration+' @ misasak\'alina\\. Raha hanafoana io fanavaozana io, tsindrio 1')
