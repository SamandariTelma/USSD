...
'Après desactivation Offre TELMA NET 12 MOIS, je short code #359#'
...
String menu=CustomKeywords.'ussd.Expected.menu'('Vous avez reactive avec succes le renouvellement automatique de NET 12 MOIS\\.')

WS.verifyMatch(actualMenu, menu, true)

//#359*83*2# desactivé NET 12 MOIS