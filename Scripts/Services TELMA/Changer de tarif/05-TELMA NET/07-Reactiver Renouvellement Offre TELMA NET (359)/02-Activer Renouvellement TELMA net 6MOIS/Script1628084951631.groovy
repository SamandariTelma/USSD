...
'Après desactivation Offre TELMA NET 6 MOIS, je short code #359#'
...
String menu=CustomKeywords.'ussd.Expected.menu'('Vous avez reactive avec succes le renouvellement automatique de NET 6 MOIS\\.')

WS.verifyMatch(actualMenu, menu, true)

//#359*82*2# desactivé NET 6 MOIS
