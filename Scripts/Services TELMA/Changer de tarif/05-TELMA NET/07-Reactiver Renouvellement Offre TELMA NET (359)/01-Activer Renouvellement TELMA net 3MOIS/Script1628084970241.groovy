...
'Après desactivation Offre TELMA NET 3 MOIS, je short code #359#'
...
String menu=CustomKeywords.'ussd.Expected.menu'('Vous avez reactive avec succes le renouvellement automatique de NET 3 MOIS\\.')

WS.verifyMatch(actualMenu, menu, true)

//#359*81*2# desactivé NET 3 MOIS