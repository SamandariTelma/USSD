...
'Vérifier la conformité du message'
menu=CustomKeywords.'ussd.Expected.menu'('NET ONE MONTH 3 Go, il vous reste \\d{1,5}\\.\\d Mo utilisable à toute heure jusqu au '+dateExpiration+' inclus\\.',
	'NET ONE MONTH 3 Go \\d{1,5}\\.\\d Mo sisa ny bonus\\-nao azo ampiasaina @ ora rehetra hatramin ny '+dateExpiration+'\\.')
