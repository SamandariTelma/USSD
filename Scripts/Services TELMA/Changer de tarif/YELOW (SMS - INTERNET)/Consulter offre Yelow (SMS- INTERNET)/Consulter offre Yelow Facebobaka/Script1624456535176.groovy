...
'Vérifier la conformité du message'
menu=CustomKeywords.'ussd.Expected.menu'('Votre bonus YELOW FACEBOBAKA restant, \\d{1,4}.\\d Mo utilisable toute la journee valable jusqu au <datedExpiration> inclus\\.',
	'Ny bonus YELOW FACEBOBAKA - nao: \\d{1,4}.\\d Mo ny tontolo andro ampiasaina hatramin ny <datedExpiration>')
