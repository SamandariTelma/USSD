...
'Vérifier la conformité du message'
menu=CustomKeywords.'ussd.Expected.menu'('Bonus YELOW 1000 restants: \\d{1,3} SMS vers tous les opérateurs et/ou \\d{1,4}.\\d Mo utilisable à toute heure \\+ \\d{1,4}.\\d Mo la nuit jusqu au <datedExpiration>',
	'Bonus YELOW 1000 tavela: \\d{1,3} SMS mankany @ tambazotra rehetra \\+ \\d{1,4}.\\d Mo ny alina hatramin ny <datedExpiration>')
