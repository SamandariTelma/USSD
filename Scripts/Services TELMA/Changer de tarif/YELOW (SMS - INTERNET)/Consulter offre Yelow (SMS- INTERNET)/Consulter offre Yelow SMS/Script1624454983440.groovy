...
'Vérifier la conformité du message'
menu=CustomKeywords.'ussd.Expected.menu'('Bonus YELOW SMS restants, \\d{1,3} SMS TELMA et \\d{1,3} SMS autres opérateurs jusqu au <datedExpiration>\\.',
	'Bonus YELOW SMS , \\d{1,3} SMS TELMA + \\d{1,3} SMS mankany @ tambazotra hafa azo ampiasaina hatramin ny <datedExpiration>\\.')
