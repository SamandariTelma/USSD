...
'Vérifier la conformité du message'
menu=CustomKeywords.'ussd.Expected.menu'('Bonus YELOW 200 restants: \\d{1,3} SMS Telma et/ou \\d{1,4}.\\d Mo utilisable à toute heure jusqu au <datedExpiration>',
	'Bonus YELOW 200 tavela: \\d{1,3} SMS Telma sy/na <dataRestant> Mo @ ora rehetra hatramin ny <datedExpiration>')
