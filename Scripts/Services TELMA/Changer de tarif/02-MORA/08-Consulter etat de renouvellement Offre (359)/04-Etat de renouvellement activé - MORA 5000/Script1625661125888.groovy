...
String menu=CustomKeywords.'ussd.Expected.menu'('1 Votre offre MORA+ 5000 sera automatiquement renouvelee le '+dateExpiration+' a minuit\\. Pour desactiver le renouvellement tapez 1',
	'1 Ny tolotra MORA+ 5000 dia hohavaozina ny '+dateExpiration+' @ misasak\'alina\\. Raha hanafoana io fanavaozana io, tsindrio 1')
