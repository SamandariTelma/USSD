...
'En tant que GP, j\'effectue un achat offre Mora + 5000 via MVola:  *611*35*1#'
String actualMenu=CustomKeywords.'ussd.Send.code'(GlobalVariable.shortCoddeDirectAchat+'*35*1#', numeroInitiateur)
