...
'Après desactivation Offre MORA 500, je short code #359#'
...
String menu=CustomKeywords.'ussd.Expected.menu'('Vous avez reactive avec succes le renouvellement automatique de MORA 500\\.')
