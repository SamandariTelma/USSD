...
String actualMenu=CustomKeywords.'ussd.Send.code'(GlobalVariable.shortCoddeDirectAchat+'*67*1#', numeroInitiateur)
...
String menu = CustomKeywords.'ussd.Expected.menu'('Pour confirmer le paiement de l\'offre YELOW100 via MVola d\'un montant de '+montant+' Ar, Entrer code secret :',
	'Raha manaiky ny hividy ny tolotra YELOW100 amin\'ny sarany '+montant+' Ar, avy amin ny kaonty MVola ianao dia, Ampidiro ny kaody miafina :')
