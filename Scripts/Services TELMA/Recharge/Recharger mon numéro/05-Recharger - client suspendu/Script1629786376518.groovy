...
'Je saisis un numero de code de recharge valide'
String actualMenu=CustomKeywords.'ussd.Send.response'(codeRecharge)

'Vérifier la conformité du message ussd'
String menu=CustomKeywords.'ussd.Expected.menu'('Votre compte de recharge est suspendu', 'Nahato ny kaonty famahananao')
