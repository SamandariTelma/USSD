...
'Je saisis 1 pour confirmer la suppression'
actualMenu=CustomKeywords.'ussd.Send.response'('1')

menu=CustomKeywords.'ussd.Expected.menu'('Vous pouvez uniquement modifier un numero Friends & Familly par mois\\. Rendez vous au mois prochain !',
