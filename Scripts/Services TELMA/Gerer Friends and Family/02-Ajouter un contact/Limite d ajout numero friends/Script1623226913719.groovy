...
WebUI.callTestCase(findTestCase('Services TELMA/Gerer Friends and Family/02-Ajouter un contact/Ajouter contact avec succès'), 
    [('numeroInitiateur') : GlobalVariable.msisdnInitiateur, ('numeroAAjouter') : GlobalVariable.msisdnAAjouter2], FailureHandling.CONTINUE_ON_FAILURE)

'Ajouter un 3ème numéro dans ma liste FAF'
WebUI.callTestCase(findTestCase('Services TELMA/Gerer Friends and Family/02-Ajouter un contact/Ajouter contact avec succès'), 
    [('numeroInitiateur') : GlobalVariable.msisdnInitiateur, ('numeroAAjouter') : GlobalVariable.msisdnAAjouter3], FailureHandling.CONTINUE_ON_FAILURE)
