...
String menu=CustomKeywords.'ussd.Expected.menu'('NET ONE WEEK 2 Go! Beneficiez de 2 Go de DATA utilisable a toute heure pendant 7 jours pour seulement 10\\.000 Ar\\. En profiter\\? 1\\-OUI ; 0\\-NON',
	'NET ONE WEEK 2 Go! Mahazoa 2 Go DATA azo ampiasaina @ ora rehetra @ sarany 10\\.000Ar monja mandritry ny 7 andro\\. Hanararoatra\\? 1\\-ENY ; 0\\-TSIA')
