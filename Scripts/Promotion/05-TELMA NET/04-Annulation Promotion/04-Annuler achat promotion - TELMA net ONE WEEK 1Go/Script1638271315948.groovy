...
'Je saisis 2 (NET WEEK 500 Mo)'
String actualMenu=CustomKeywords.'ussd.Send.response'('2')

'Vérifier la conformité du prompt'
String menu=CustomKeywords.'ussd.Expected.menu'('NET ONE WEEK 1 Go! Beneficiez de 1 Go de DATA utilisable a toute heure pendant 7 jours pour seulement 5\\.000 Ar\\. En profiter\\? 1\\-OUI ; 0\\-NON',
	'NET ONE WEEK 1 Go! Mahazoa 1 Go DATA azo ampiasaina @ ora rehetra @ sarany 5\\.000Ar monja mandritry ny 7 andro\\. Hanararoatra\\? 1\\-ENY ; 0\\-TSIA')
