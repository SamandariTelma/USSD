...
'Je saisis 1 (NET WEEK 250 Mo)'
String actualMenu=CustomKeywords.'ussd.Send.response'('1')

'Vérifier la conformité du prompt'
String menu=CustomKeywords.'ussd.Expected.menu'('NET ONE WEEK 500 Mo! Beneficiez de 500 Mo de DATA utilisable a toute heure pendant 7 jours pour seulement 3\\.000 Ar\\. En profiter\\? 1\\-OUI ; 0\\-NON',
	'NET ONE WEEK 500 Mo! Mahazoa 500 Mo DATA azo ampiasaina @ ora rehetra @ sarany 3\\.000Ar monja mandritry ny 7 andro\\. Hanararoatra\\? 1\\-ENY ; 0\\-TSIA')
