...
'Je saisis 2(NET ONE WEEK 800Mo)'
...
String menu=CustomKeywords.'ussd.Expected.menu'('L achat de votre NET ONE WEEK 800 Mo est reussi\\. Vous avez 800 Mo de DATA utilisable à toute heure\\. Achetez via Mvola et gagnez 20% de bonus\\. \\(#111\\*1#\\)',
	'Tafiditra ny NET ONE WEEK 800Mo novidinao\\.Manana 800 Mo azo ampiasaina @ ora rehetra ianao\\. Vidio Mvola ny tolotra ary mahazahoa bonus 20%\\.\\(#111\\*1#\\)')
