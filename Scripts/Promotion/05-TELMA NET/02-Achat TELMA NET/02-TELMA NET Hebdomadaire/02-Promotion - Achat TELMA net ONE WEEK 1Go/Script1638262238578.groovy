...
String menu=CustomKeywords.'ussd.Expected.menu'('L achat de votre NET ONE WEEK 1 Go est reussi\\. Vous avez 1 Go de DATA utilisable à toute heure\\. Achetez via Mvola et gagnez 20% de bonus\\. \\(#111\\*1#\\)\\.',
