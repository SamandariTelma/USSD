...
'Je saisis 4(NET ONE MONTH 25 Go)'
...
String menu=CustomKeywords.'ussd.Expected.menu'('L achat de votre NET ONE MONTH 25 Go est reussi\\. Vous avez 25 Go de DATA utilisable a toute heure\\. Achetez via Mvola et gagnez 20% de bonus \\(#111\\*1#)\\.',
	'Tafiditra ny tolotra NET ONE MONTH 25 Go novidianao\\. Manana 25 Go azo ampiasaina @ora rehetra ianao\\. Vidio @Mvola ny tolotra ary mahazo bonus 20%\\. \\(#111*1#\\)\\.')
