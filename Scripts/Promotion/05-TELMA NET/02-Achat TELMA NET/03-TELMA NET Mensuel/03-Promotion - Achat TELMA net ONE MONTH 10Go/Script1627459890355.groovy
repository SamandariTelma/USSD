...
'Je saisis 3(NET ONE MONTH 10 Go)'
...
String menu=CustomKeywords.'ussd.Expected.menu'('L achat de votre NET ONE MONTH 10 Go est reussi\\. Vous avez 10 Go de DATA utilisable à toute heure\\. Achetez via Mvola et gagnez 20% de bonus\\. \\(#111\\*1#\\)\\.',
	'Tafiditra ny tolotra NET ONE MONTH 10 Go novidianao\\. Manana 10 Go azo ampiasaina @ ora rehetra ianao\\. Vidio @Mvola ny tolotra ary mahazoa bonus 20%\\. \\(#111\\*1#\\)\\.')
