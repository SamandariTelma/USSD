...
'Je saisis 1(NET ONE MONTH 2,5 Go)'
...
String menu=CustomKeywords.'ussd.Expected.menu'('L achat de votre NET ONE MONTH 2,5 Go est reussi\\. Vous avez 2,5 Go de DATA utilisable à toute heure\\. Achetez via Mvola et gagnez 20% de bonus\\. \\(#111\\*1#\\)\\.',
