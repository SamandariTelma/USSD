...
String menu=CustomKeywords.'ussd.Expected.menu'('Votre achat de NET ONE MONTH 20 Go est reussi\\. Vous avez 20 Go de DATA utilisable a toute heure\\. Achetez via Mvola et gagnez 20% de bonus \\(#111\\*1#\\)\\.',
