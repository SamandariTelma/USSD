...
'Je saisis 4(NET ONE MONTH 30 Go)'
...
String menu=CustomKeywords.'ussd.Expected.menu'('L achat de votre NET ONE MONTH 30 Go est reussi\\. Vous avez 30 Go de DATA utilisable à toute heure\\. Achetez via Mvola et gagnez 20% de bonus\\. \\(#111\\*1#\\)\\.',
