...
String montantMora = "${montantMora1000}"
...
'Je saisis  2 (MORA ONE) et je valide'
CustomKeywords.'ussd.Send.response'('2')
...
String menu=CustomKeywords.'ussd.Expected.menu'('L achat du Mora One est reussi\\. Bonus restants:#359#\\. Achats et consultation bonus SIMPLE&RAPIDE via l app Telma&Moi\\. Kadoa 20% si achat via MVola',
