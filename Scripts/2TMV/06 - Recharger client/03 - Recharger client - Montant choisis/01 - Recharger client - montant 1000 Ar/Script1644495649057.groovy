...
'Je saisis 2 (Envoyer 1000 Ar) et je valide'
...
String menu = CustomKeywords.'ussd.Expected.menu'('Votre d\'achat est en cours de traitement\\.', 'Tontosa ny fividiana fahana ho an\'ny laharako\\.')
