...
'En tant que numero de type Chef de zone, j\'envoi du stock à un numéro de type Grossiste'
WebUI.callTestCase(findTestCase('2TMV/Envoyer Stock/00-Called test case/Envoi stock - destinataire non eligible'), [('numeroEnvoyeur') : numeroEnvoyeur
