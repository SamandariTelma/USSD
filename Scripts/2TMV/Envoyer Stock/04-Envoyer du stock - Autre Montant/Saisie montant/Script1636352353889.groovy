...
'Je saisis un montant inférieur à 10 000 et je valide '
actualMenu=CustomKeywords.'ussd.Send.response'('99999')

'Vérifier la conformité du prompt'
menu=CustomKeywords.'ussd.Expected.menu'('Le montant est incorrect\\. Merci de verifier :','Sanda-mbola diso :')
