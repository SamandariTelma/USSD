...
'En tant que numero de type Livreur, j\'envoi du stock à un numéro de type point de vente'
WebUI.callTestCase(findTestCase('2TMV/Envoyer Stock/00-Called test case/Envoi stock - destinataire eligible'), [('numeroEnvoyeur') : numeroEnvoyeur
