...
actualMenu=CustomKeywords.'ussd.Send.response'('18000')
...
'Vérifier la conformité du prompt'
menu=CustomKeywords.'ussd.Expected.menu'('Envoyer 18 000 Ar au '+numeroRevendeur+' \\? No pour SMS de confirmation '+numeroANotifier+'\n1 \\- Oui\n0 \\- Non', 
