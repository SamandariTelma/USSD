...
String actualMenu=CustomKeywords.'ussd.Send.response'('8')

'Vérifier la conformité du prompt'
String menu=CustomKeywords.'ussd.Expected.menu'('Veuillez saisir un montant entre 100 ar et 1 000 000 ar : ')
...
'Vérifier que je reste sur le prompt saisie montant'
WS.verifyMatch(actualMenu, menu, true)

'Je saisis un montant supérieur à 1 000 000 et je valide '
actualMenu=CustomKeywords.'ussd.Send.response'('20 000 000')

'Vérifier que je reste sur le prompt saisie montant'
WS.verifyMatch(actualMenu, menu, true)

'Je saisis un montant au format incorrecte'
