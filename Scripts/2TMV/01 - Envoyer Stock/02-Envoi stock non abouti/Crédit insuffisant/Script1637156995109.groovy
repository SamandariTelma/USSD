...
actualMenu=CustomKeywords.'ussd.Send.response'('1000000')

'Vérifier la conformité du prompt'
menu=CustomKeywords.'ussd.Expected.menu'('Envoyer au No : ','Alefa amin\'ny No :')
...
'Vérifier la conformité du prompt'
menu=CustomKeywords.'ussd.Expected.menu'('Envoyer 1 000 000 Ar au '+numeroRevendeur+' \\? No pour SMS de confirmation '+numeroANotifier+'\n1 \\- Oui\n0 \\- Non', 
	'Andefa 1 000 000 Ar amin\'ny '+numeroRevendeur+' \\?  No pour SMS de confirmation '+numeroANotifier+'\n1 \\- Eny \n0 \\- Tsia')
