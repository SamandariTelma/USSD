...
WebUI.callTestCase(findTestCase('2TMV/00 - Called test case/Consulter solde 2tmv'), [('numeroInitiateur') :numeroRecepteur
		, ('pinInitiateur') : pinEnvoyeur], FailureHandling.CONTINUE_ON_FAILURE)
int soldeRecepteurAvant=GlobalVariable.solde2tmv

'En tant que numero de type Grossiste, j\'envoi du stock inférieur à 100 000 Ar à un numéro de type Chef de zone'
...
'Consulter le solde du chef de zone l\'envoi'
WebUI.callTestCase(findTestCase('2TMV/00 - Called test case/Consulter solde 2tmv'), [('numeroInitiateur') : numeroRecepteur
		, ('pinInitiateur') : pinEnvoyeur], FailureHandling.CONTINUE_ON_FAILURE)
